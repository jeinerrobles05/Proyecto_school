...
class Webinar extends Model
{
    ...
    public function getTasksAverageGradeAttribute()
    {
        $tasks = Task::where('webinar_id', $this->id)
    ...
    {
        return $this->tasks()->where('status', 'active')
    ...
    public function scopeHandleFilters($query)
    {
        ...
        if (!empty($moreOptions) and is_array($moreOptions)) {
            ...
            if (in_array('with_task', $moreOptions)) {
    ...
    {
        return $this->hasMany('App\Models\Api\Task', 'webinar_id', 'id');
    }
}
