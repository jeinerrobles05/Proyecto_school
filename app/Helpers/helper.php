...
/**
 * @param null $page => admin_login, admin_dashboard, login, register, remember_pass, search, categories,courses,
...
function sendNotificationTask($template, $options, $user_id = null, $group_id = null, $sender = 'system', $type = 'single')
{
    $notificationTemplate = \App\Models\NotificationTemplate::where('id', $template)->first();
...
function sendNotificationToEmailTask($template, $options, $email)
{
    $notificationTemplate = \App\Models\NotificationTemplate::where('id', $template)->first();
