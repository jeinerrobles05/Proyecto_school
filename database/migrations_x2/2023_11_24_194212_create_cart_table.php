...
class CreateCartTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cart', function (Blueprint $table) {
            ...
            $table->unsignedInteger('bundle_id')->nullable()->index('cart_bundle_id_foreign');
            $table->unsignedInteger('product_order_id')->nullable()->index('cart_product_order_id_foreign');
            ...
            $table->unsignedInteger('gift_id')->nullable()->index('cart_gift_id_foreign');
            ...
            $table->unsignedInteger('product_discount_id')->nullable()->index('cart_product_discount_id_foreign');
            $table->unsignedInteger('installment_payment_id')->nullable()->index('cart_installment_payment_id_foreign');
