...
class CreateCommentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('comments', function (Blueprint $table) {
            ...
            $table->unsignedInteger('bundle_id')->nullable()->index('comments_bundle_id_foreign');
            $table->unsignedInteger('upcoming_course_id')->nullable()->index('comments_upcoming_course_id_foreign');
            $table->unsignedInteger('blog_id')->nullable()->index('blog_id');
            $table->unsignedInteger('product_id')->nullable()->index('comments_product_id_foreign');
            $table->unsignedInteger('product_review_id')->nullable();
