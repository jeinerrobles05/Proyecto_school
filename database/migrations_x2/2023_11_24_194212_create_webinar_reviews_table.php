...
class CreateWebinarReviewsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('webinar_reviews', function (Blueprint $table) {
            ...
            $table->unsignedInteger('webinar_id')->nullable()->index('webinar_reviews_webinar_id_foreign');
            $table->unsignedInteger('bundle_id')->nullable()->index('webinar_reviews_bundle_id_foreign');
