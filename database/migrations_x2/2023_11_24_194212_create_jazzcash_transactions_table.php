...
class CreateJazzcashTransactionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('jazzcash_transactions', function (Blueprint $table) {
            ...
            $table->longText('order')->comment('Order data fields and values');
            $table->longText('request')->comment('Jazzcash request data fields and values');
            $table->longText('response')->nullable()->comment('Jazzcash response data fields and values');
