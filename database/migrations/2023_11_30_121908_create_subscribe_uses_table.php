...
class CreateSubscribeUsesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('subscribe_uses', function (Blueprint $table) {
            ...
            $table->unsignedInteger('webinar_id')->nullable()->index('subscribe_uses_webinar_id_foreign');
            $table->unsignedInteger('bundle_id')->nullable()->index('subscribe_uses_bundle_id_foreign');
            $table->unsignedInteger('sale_id')->index('subscribe_uses_sale_id_foreign');
            $table->unsignedInteger('installment_order_id')->nullable()->index('subscribe_uses_installment_order_id_foreign');
        });
    }
