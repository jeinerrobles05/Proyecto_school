...
class CreateNoticeboardsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('noticeboards', function (Blueprint $table) {
            ...
            $table->unsignedInteger('instructor_id')->nullable()->index('noticeboards_instructor_id_foreign');
            $table->unsignedInteger('webinar_id')->nullable()->index('noticeboards_webinar_id_foreign');
