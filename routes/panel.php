...
Route::group(['namespace' => 'Panel', 'prefix' => 'panel', 'middleware' => ['check_mobile_app', 'impersonate', 'panel', 'share', 'check_maintenance']], function () {
    ...
    Route::group(['prefix' => 'tasks'], function () {
        Route::group(['middleware' => 'user.not.access'], function () {
            ...
            Route::get('/{id}/edit', 'TaskController@edit')->name('panel_edit_task');
            Route::post('/{id}/update', 'TaskController@update');
            Route::get('/{id}/delete', 'TaskController@destroy');
            Route::post('/{id}/order-items', 'TaskController@orderItems');
            Route::get('/getAllByWebinarId/{webinar_id}', 'TaskController@getAllByWebinarId');
        });
        Route::get('/{id}/start', 'TaskController@start');
        Route::post('/{id}/store-result', 'TaskController@tasksStoreResult');
        Route::get('/{taskResultId}/status', 'TaskController@status')->name('task_status');
        Route::get('/{taskResultId}/edit-result-student', 'TaskController@editResult_student');
        Route::post('/{taskResultId}/update-result-student', 'TaskController@updateResult_student');
        Route::get('/{taskResultId}/delete-result', 'TaskController@destroyTaskResultStudent');

        Route::get('/my-results', 'TaskController@myResults');
        Route::get('/opens', 'TaskController@opens');

        Route::get('/{taskResultId}/result', 'TaskController@showResult');

        Route::group(['prefix' => 'results'], function () {
            Route::get('/', 'TaskController@results');
            Route::get('/{taskResultId}/delete', 'TaskController@destroyTaskResult');
            Route::get('/{taskResultId}/showCertificate', 'CertificateController@makeCertificate');
        });

        Route::get('/{taskResultId}/edit-result', 'TaskController@editResult');
        Route::post('/{taskResultId}/update-result', 'TaskController@updateResult');


    });

    Route::group(['prefix' => 'tasks-questions'], function () {
        Route::post('/store', 'TaskQuestionController@store');
        Route::get('/{id}/edit', 'TaskQuestionController@edit');
        Route::get('/{id}/getQuestionByLocale', 'TaskQuestionController@getQuestionByLocale');
        Route::post('/{id}/update', 'TaskQuestionController@update');
        Route::get('/{id}/delete', 'TaskQuestionController@destroy');
    });
    ...
    Route::group(['prefix' => 'webinar-task'], function () {
        Route::post('/store', 'WebinarTaskController@store');
        Route::post('/{id}/update', 'WebinarTaskController@update');
        Route::get('/{id}/delete', 'WebinarTaskController@destroy');
    });
