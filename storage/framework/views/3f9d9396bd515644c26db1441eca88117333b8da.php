        ...
        <ul class="sidebar-menu">
            ...
            <?php endif; ?>
                <li class="nav-item dropdown <?php echo e((request()->is(getAdminPanelUrl('/bundles*', false)) and !request()->is(getAdminPanelUrl('/bundles/comments*', false))) ? 'active' : ''); ?>">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_bundles_list')): ?>
                            <li class="<?php echo e((request()->is(getAdminPanelUrl('/grupos', false)) and request()->get('type') == 'course') ? 'active' : ''); ?> ">
                                <a href="<?php echo e(getAdminPanelUrl()); ?>/grupos" class="nav-link <?php if(!empty($sidebarBeeps['bundles']) and $sidebarBeeps['bundles']): ?> beep beep-sidebar <?php endif; ?>"><?php echo e(trans('admin/main.lists')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_bundles_create')): ?>
                            <li class="<?php echo e((request()->is(getAdminPanelUrl('/grupos/create', false))) ? 'active' : ''); ?> ">
                                <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/grupos/create"><?php echo e(trans('admin/main.new')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
...
<?php /**PATH C:\laragon\www\school_dz\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>