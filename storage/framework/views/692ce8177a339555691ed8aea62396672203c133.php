            ...
            <form action="<?php echo e(getAdminPanelUrl()); ?>/settings/main" method="post">
                ...
                <?php
                    $pages = ['admin_login','admin_dashboard', 'login','register','remember_pass','verification',
                        'search','categories','courses','become_instructor','certificate_validation','blog','instructors',
...
<?php /**PATH C:\laragon\www\school_dz\resources\views/admin/settings/personalization/page_background.blade.php ENDPATH**/ ?>