...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <section class="mt-30 task-form">
            <form action="/panel/tasks/<?php echo e($newTaskStart->task->id); ?>/update-result-student" method="post" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>"><?php echo e($taskResult->results); ?></textarea>
...
unset($__errorArgs, $__bag); ?></div>
                                <?php if($taskResult->attach): ?>
                                    <br>
                                    <a href="<?php echo e(url($taskResult->attach)); ?>" target="_blank" class="font-12 mt-10 text-dark-blue"><i data-feather="paperclip" height="14"></i> <?php echo e($taskResult->attach); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\school_dz\resources\views/web/default/panel/tasks/task_result_student.blade.php ENDPATH**/ ?>