...
<div class="panel-sidebar pt-50 pb-25 px-25" id="panelSidebar">
    ...
    <ul id="panel-sidebar-scroll" class="sidebar-menu  " <?php if((!empty($isRtl) and $isRtl)): ?> data-simplebar-direction="rtl" <?php endif; ?>>
        ...
        <li class="sidenav-item <?php echo e((request()->is('panel/tasks') or request()->is('panel/tasks/*')) ? 'sidenav-item-active' : ''); ?>">
            <a class="d-flex align-items-center" data-toggle="collapse" href="#tasksCollapse" role="button" aria-expanded="false" aria-controls="tasksCollapse">
                <span class="sidenav-item-icon mr-10">
                    <?php echo $__env->make('web.default.panel.includes.sidebar_icons.assignments', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </span>
                <span class="font-14 text-dark-blue font-weight-500"><?php echo e(trans('panel.tasks')); ?></span>
            </a>

            <div class="collapse <?php echo e((request()->is('panel/tasks') or request()->is('panel/tasks/*')) ? 'show' : ''); ?>" id="tasksCollapse">
                <ul class="sidenav-item-collapse">
                    <?php if(trim($authUser->role_name) == "organization" || trim($authUser->role_name) == "teacher"): ?>
                        <li class="mt-5 <?php echo e((request()->is('panel/tasks/new')) ? 'active' : ''); ?>">
                            <a href="/panel/tasks/new"><?php echo e(trans('task.new_task')); ?></a>
                        </li>
                        <li class="mt-5 <?php echo e((request()->is('panel/tasks')) ? 'active' : ''); ?>">
                            <a href="/panel/tasks"><?php echo e(trans('public.list')); ?></a>
                        </li>
                        <li class="mt-5 <?php echo e((request()->is('panel/tasks/results')) ? 'active' : ''); ?>">
                            <a href="/panel/tasks/results"><?php echo e(trans('public.results')); ?></a>
                        </li>
                    <?php endif; ?>

                    <?php if(trim($authUser->role_name) == "user"): ?>
                        <li class="mt-5 <?php echo e((request()->is('panel/tasks/my-results')) ? 'active' : ''); ?>">
                            <a href="/panel/tasks/my-results"><?php echo e(trans('public.my_results')); ?></a>
                        </li>

                        <li class="mt-5 <?php echo e((request()->is('panel/tasks/opens')) ? 'active' : ''); ?>">
                            <a href="/panel/tasks/opens"><?php echo e(trans('public.not_participated')); ?></a>
                        </li>
                    <?php endif; ?>
...
<?php /**PATH C:\laragon\www\school_dz\resources\views/web/default/panel/includes/sidebar.blade.php ENDPATH**/ ?>