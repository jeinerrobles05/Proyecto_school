...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e($tasksResultsCount); ?></strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500"><?php echo e(trans('task.open_results')); ?></span>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <select name="instructorMyResult" class="form-control select2" data-placeholder="<?php echo e(trans('public.all')); ?>">
                                            <option value="all"><?php echo e(trans('public.all')); ?></option>
                                            ...
                                            <?php $__currentLoopData = $allInstructors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instructorId => $instructorName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($instructorId); ?>" <?php if(request()->get('instructorMyResult') == $instructorId): ?> selected <?php endif; ?>><?php echo e($instructorName); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
    ...
    <section class="mt-35">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title"><?php echo e(trans('task.my_tasks')); ?></h2>
            ...
            <form action="" method="get">
                <div class="d-flex align-items-center flex-row-reverse flex-md-row justify-content-start justify-content-md-center mt-20 mt-md-0">
                    ...
                    <div class="custom-control custom-switch">
                        <input type="checkbox" name="open_results" <?php if(request()->get('open_results','') == 'on'): ?> checked <?php endif; ?> class="custom-control-input" id="onlyOpenTasksSwitch">
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center"><?php echo e(trans('task.my_grade')); ?></th>
                                ...
                                <?php $__currentLoopData = $tasksResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-left">
                                            <div class="user-inline-avatar d-flex align-items-center">
                                                <div class="avatar bg-gray200">
                                                    <img src="<?php echo e($result->task->creator->getAvatar()); ?>" class="img-cover" alt="">
                                                </div>
                                                <div class=" ml-5">
                                                    <span class="d-block"><?php echo e($result->task->creator->full_name); ?></span>
                                                    <span class="mt-5 font-12 text-gray d-block"><?php echo e($result->task->creator->email); ?></span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-left">
                                        ...
                                        <span class="d-block text-<?php echo e(($result->status == 'passed') ? 'primary' : ($result->status == 'waiting' ? 'warning' : 'danger')); ?>">
                                            <?php echo e(trans('task.'.$result->status)); ?>
                                        ...
                                        <td class="align-middle"><?php echo e(dateTimeFormat($result->task->expiry_days,'j M Y H:i')); ?></td>
                                            ...
                                            <div class="btn-group dropdown table-actions table-actions-lg table-actions-lg">
                                                ...
                                                <div class="dropdown-menu">
                                                    <?php if(!$result->can_try and $result->status != 'waiting'): ?>
                                                        <a href="/panel/tasks/<?php echo e($result->id); ?>/result" class="webinar-actions d-block mt-10"><?php echo e(trans('public.view_answers')); ?></a>
                                                    <?php endif; ?>

                                                    <?php if($result->status == 'waiting' and $result->task->expiry_days >= time()): ?>
                                                        <?php if($result->can_try): ?>
                                                                <a href="/panel/tasks/<?php echo e($result->id); ?>/edit-result-student" class="webinar-actions d-block mt-10"><?php echo e(trans('public.edit')); ?></a>
                                                                <a href="/panel/tasks/<?php echo e($result->id); ?>/delete-result" class="webinar-actions d-block mt-10 delete-action"><?php echo e(trans('public.delete')); ?></a>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    ...
                                                    <a href="<?php echo e($result->task->webinar->getUrl()); ?>" class="webinar-actions d-block mt-10"><?php echo e(trans('webinars.webinar_page')); ?></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\school_dz\resources\views/web/default/panel/tasks/my_results.blade.php ENDPATH**/ ?>