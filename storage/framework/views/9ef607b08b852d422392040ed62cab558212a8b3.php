                ...
                <div class="course-content-body user-select-none">
                    ...
                    <div class="mt-35">
                        <ul class="nav nav-tabs bg-secondary rounded-sm p-15 d-flex align-items-center justify-content-between" id="tabs-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="position-relative font-14 text-white <?php echo e((request()->get('tab','') == 'study_plan') ? 'active' : ''); ?>" id="content-tab" data-toggle="tab"
                                   href="#study_plan" role="tab" aria-controls="study_plan"
                                   aria-selected="false"><?php echo e(trans('product.study_plan')); ?> (<?php echo e($webinarStudyPlanCount); ?>)</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade <?php echo e((request()->get('tab','') == 'study_plan') ? 'show active' : ''); ?>" id="study_plan" role="tabpanel" aria-labelledby="content-tab">
                                <?php echo $__env->make(getTemplate().'.course.tabs.study_plan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                    ...
                    <div class="px-20 pb-30">
                        ...
                        <form action="/cart/store" method="post">
                            ...
                            <div class="mt-20 d-flex flex-column">
                                ...
                                <?php elseif($course->price > 0): ?>
                                    <?php if($course->type!='classroom_course'): ?>
                                    ...
                                    <?php else: ?>
                                        <a href="/register_classroom_course/<?php echo e($course->id); ?>/search" class="btn btn-primary " >
                                            <?php echo e(trans('public.interested')); ?>
                        ...
                        <?php if($course->type!='classroom_course'): ?>
                            <div class="mt-35">
                                ...
                                <?php if($course->tasks->where('status', \App\models\Task::ACTIVE)->count() > 0): ?>
                                    <div class="mt-20 d-flex align-items-center text-gray">
                                        <i data-feather="file-text" width="20" height="20"></i>
                                        <span class="ml-5 font-14 font-weight-500"><?php echo e(trans('webinars.online_tasks_count',['task_count' => $course->tasks->where('status', \App\models\Task::ACTIVE)->count()])); ?></span>
                                    </div>
                                <?php endif; ?>
                            ...
                            <?php if($course->isWebinar()): ?>
                                <div class="col">
                                    <a href="<?php echo e($course->addToCalendarLink()); ?>" target="_blank" class="d-flex flex-column align-items-center text-center text-gray">
                                        ...
                                        <span class="font-12"><?php echo e(trans('webinars.downloadable_content')); ?></span>
                                    </a>
                                </div>
                            <?php endif; ?>
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <script>
        ...
        var canNotTryAgainTaskToastTitleLang = '<?php echo e(trans('public.can_not_try_again_task_toast_lang')); ?>';
        var canNotTryAgainTaskToastMsgLang = '<?php echo e(trans('public.can_not_try_again_task_toast_msg_lang')); ?>';
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\school_dz\resources\views/web/default/course/index.blade.php ENDPATH**/ ?>