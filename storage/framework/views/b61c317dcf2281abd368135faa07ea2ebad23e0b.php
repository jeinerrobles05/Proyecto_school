                        ...
                        <div class="d-flex align-items-center justify-content-between" role="tab" id="chapter_<?php echo e($chapter->id); ?>">
                            ...
                            <div class="d-flex align-items-center">
                                <span class="mr-15 font-14 text-gray">
                                    ...
                                    <?php if($course->type != 'classroom_course'): ?><?php echo e(!empty($chapter->getDuration()) ? ' - ' . convertMinutesToHourAndMinute($chapter->getDuration()) .' '. trans('public.hr') : ''); ?><?php endif; ?>
                                </span>
...
<?php /**PATH C:\laragon\www\school_dz\resources\views/web/default/course/tabs/contents/chapter.blade.php ENDPATH**/ ?>