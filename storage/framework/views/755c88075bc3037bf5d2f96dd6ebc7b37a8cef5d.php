            ...
            <div class="js-content-form text_lesson-form" data-action="<?php echo e(getAdminPanelUrl()); ?>/text-lesson/<?php echo e(!empty($textLesson) ? $textLesson->id . '/update' : 'store'); ?>">
                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="form-group">
                            <?php if(empty($webinar) or (!empty($webinar) and $webinar->type!=\App\Models\Webinar::$classroomCourse)): ?>
...
<?php /**PATH C:\laragon\www\school_dz\resources\views/admin/webinars/create_includes/accordions/text-lesson.blade.php ENDPATH**/ ?>