...
@section('content')
            ...
            <div class="row">
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">{{ trans('task.need_to_review') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5">{{ $taskResultsCount }}</strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5">{{ $taskAvgGrad }}</strong>
                        <span class="font-16 text-gray font-weight-500">{{ trans('task.average_grade') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">{{ trans('task.success_rate') }}</span>
                    </div>
                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="group_id" class="form-control select2" data-placeholder="{{ trans('public.all') }}">
                                    ...
                                    @foreach($tasks as $task)
                                        <option value="{{ $task->group_id }}">{{ $task->webinar->title }} - {{ $task->group->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                                ...
                                <div class="col-12 col-lg-7">
                                    <div class="form-group">
                                        ...
                                        <select name="task_id" class="form-control select2" data-placeholder="{{ trans('public.all') }}">
                                            ...
                                            @foreach($tasks as $task)
                                                <option value="{{ $task->id }}" @if(request()->get('task_id') == $task->id) selected @endif>{{ $task->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
    ...
    <section class="mt-35">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title">{{ trans('task.student_results') }}</h2>
            ...
            <form action="/panel/tasks/results" method="get" class="">
                <div class="d-flex align-items-center flex-row-reverse flex-md-row justify-content-start justify-content-md-center mt-20 mt-md-0">
                    ...
                    <div class="custom-control custom-switch">
                        <input type="checkbox" name="open_results" class="custom-control-input" id="onlyOpenTasksSwitch" @if(request()->get('open_results',null) == 'on') checked @endif>
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">{{ trans('task.student_grade') }}</th>
                                        ...
                                        <td class="align-middle text-right">
                                            <div class="btn-group dropdown table-actions table-actions-lg table-actions-lg">
                                                ...
                                                <div class="dropdown-menu font-weight-normal">
                                                    ...
                                                    <a href="/panel/tasks/{{ $result->id }}/edit-result" class="webinar-actions d-block mt-10">{{ trans('public.review') }}</a>
                                                    <a href="/panel/tasks/results/{{ $result->id }}/delete" class="webinar-actions d-block mt-10 delete-action">{{ trans('public.delete') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
