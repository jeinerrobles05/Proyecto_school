...
@section('content')
    <div class="container">
        ...
        <section class="mt-30 task-form">
            <form action="/panel/tasks/{{ $task->id }}/store-result" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="rounded-lg shadow-sm py-25 px-20 mt-30">
                    <div class="task-card">
                        <div class="form-group">
                            ...
                            <textarea name="answer" class="summernote form-control text-left @error('answer') is-invalid @enderror"></textarea>
