...
@push('scripts_bottom')
    ...
    <script>
        ...
        var canNotTryAgainTaskToastTitleLang = '{{ trans('public.can_not_try_again_task_toast_lang') }}';
        var canNotTryAgainTaskToastMsgLang = '{{ trans('public.can_not_try_again_task_toast_msg_lang') }}';
