(function ($) {
    ...
    $('body').on('click', '.can-not-try-again-task-toast', function (e) {
        e.preventDefault();

        if (canNotTryAgainTaskToastTitleLang && canNotTryAgainTaskToastMsgLang) {
            errorToast(canNotTryAgainTaskToastTitleLang, canNotTryAgainTaskToastMsgLang);
        }
    });
